    ...
    ***************************************************************************** */
    ...
    var ChartView$3 = (function (_super) {
        ...
        ChartView.prototype.TooltipFactory = function (obj, columns) {
            var props = [obj.value, columns.find(function (a) { return a.id === obj.value; }).name];
            if (obj.color && obj.color != obj.value)
                props.push(obj.color, columns.find(function (a) { return a.id === obj.color; }).name);
            return function (obj) {
                var out = "";
